...
CREATE TABLE `db_info_for_writer` (
...
insert into `db_info_for_writer`(`db_id`,`db_type`,`db_ip`,`db_port`,`db_role`,`db_name`,`db_username`,
`db_password`,`db_modify_time`,`db_modify_user`,`db_description`,`db_tddl_info`)
values(1,1,'127.0.0.1','3306','master','hello_db00','user','pass','2014-09-01 12:00:01','jack','让天下没有难做的生意，这个事情离不开数据库.','{"hello":"world"}');


insert into `db_info_for_writer`(`db_id`,`db_type`,`db_ip`,`db_port`,`db_role`,`db_name`,`db_username`,
`db_password`,`db_modify_time`,`db_modify_user`,`db_description`,`db_tddl_info`)
values(2,1,'1.2.3.4','3306','master','hello_db01','user','pass','2014-09-01 13:00:02','jack','不是为了输赢，老罗是认真的。.','{"world":"changed"}');

insert into `db_info_for_writer`(`db_id`,`db_type`,`db_ip`,`db_port`,`db_role`,`db_name`,`db_username`,
`db_password`,`db_modify_time`,`db_modify_user`,`db_description`,`db_tddl_info`)
values(3,2,'8.8.8.8','1521','slave','hello_db','tiger','tiger','2014-09-01 14:00:03','Tom','中国好声音.','{"world":"changed"}');

insert into `db_info_for_writer`(`db_id`,`db_type`,`db_ip`,`db_port`,`db_role`,`db_name`,`db_username`,
`db_password`,`db_modify_time`,`db_modify_user`,`db_description`,`db_tddl_info`)
values(4,3,'100.100.100.100','8765','master','world_hello','user','pass','2014-09-01 15:01:04','rose','真人CS好玩吗？','{"world":"changed"}');
