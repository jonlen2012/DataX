package com.alibaba.datax.plugin.reader.oceanbasev10reader.test;
...
public class OceanBaseReaderTest extends BasicReaderPluginTest {
	...
	public void testBasic0() {
		...
		Assert.assertTrue("记录总数应该是：每张表2条记录，一共1张表，共计2条记录.", noteRecordForTest.size() == 2);
	}
	...
	public void testBasic1() {
		...
		Assert.assertEquals(1, subjobs.size());
		Assert.assertEquals(2, noteRecordForTest.size());
		Assert.assertTrue("记录总数应该是：每张表2条记录，一共1张表，共计2条记录.", noteRecordForTest.size() == 2);
	}
	...
	public void testCase1() {
		List<Record> noteRecordForTest = new ArrayList<Record>();
		List<Configuration> subjobs = super.doReaderTest("case1.json", 0, noteRecordForTest);
		Assert.assertEquals(1, subjobs.size());
		Assert.assertTrue("记录总数应该是：每张表2条记录，一共1张表，共计4条记录.", noteRecordForTest.size() == 2);
	}
	...
	public void testCase2() {
		List<Record> noteRecordForTest = new ArrayList<Record>();
		List<Configuration> subjobs = super.doReaderTest("case2.json", 0, noteRecordForTest);
		Assert.assertEquals(2, subjobs.size());
		Assert.assertTrue("记录总数应该是：每张表2条记录，一共2条全表 querySql，共计4条记录.", noteRecordForTest.size() == 4);
	}
	...
	public void testCase3() {
		List<Record> noteRecordForTest = new ArrayList<Record>();
		List<Configuration> subjobs = super.doReaderTest("case3.json", 0, noteRecordForTest);
		Assert.assertEquals(2, subjobs.size());
		Assert.assertTrue("记录总数应该是：每张表2条记录，一共2个分表，由于where过滤，每个表仅读取一条记录，共计2条记录.", noteRecordForTest.size() == 2);
	}
	...
	public void testCase4() {
		...
		List<Configuration> subjobs = super.doReaderTest("case4.json", adviceSplitNumber, noteRecordForTest);
		Assert.assertEquals(5, subjobs.size());
		Assert.assertTrue("记录总数应该是：每张表2条记录，一共5张表，共计20条记录.", noteRecordForTest.size() == 10);
	}
	...
	public void testCase5() {
		...
		List<Configuration> subjobs = super.doReaderTest("case5.json", adviceSplitNumber, noteRecordForTest);
		Assert.assertEquals(10, subjobs.size());
		Assert.assertTrue("记录总数应该是：每张表4条记录，一共5张表，共计20条记录.", noteRecordForTest.size() == 20);
	...
	public void testCase6_null() {
		List<Record> noteRecordForTest = new ArrayList<Record>();
		int adviceSplitNumber = 8;
		super.doReaderTest("case6_null.json", adviceSplitNumber, noteRecordForTest);
		for (Record r : noteRecordForTest) {
			System.out.println(r);
		}
	}
