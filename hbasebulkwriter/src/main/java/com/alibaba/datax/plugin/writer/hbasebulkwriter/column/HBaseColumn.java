...
public class HBaseColumn {
   ...
   * @throws IOException
   */
  public static void checkColumnList(HTable htable, List<? extends HBaseColumn> columnList)
          throws IOException {
	String tableName = Bytes.toString(htable.getTableName());
	@SuppressWarnings("deprecation")
  HTableDescriptor desc = htable.getConnection().getHTableDescriptors(Collections.singletonList(tableName))[0];
    boolean isErr = false;
