...
public class HBaseRegionRouter extends UDF {
  ...
  //private static final String PREFIX_PHOENIX_TYPE = "ph_";
	...
	public static JSONArray getRegionsJson(String table, String confPath, String clusterId) {
		Configuration conf = HBaseHelper.getConfiguration(null, confPath, clusterId);
