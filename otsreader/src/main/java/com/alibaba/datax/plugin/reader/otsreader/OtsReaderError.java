...
public class OtsReaderError implements ErrorCode {
    ...
    public final static OtsReaderError ERROR = new OtsReaderError("OtsReaderError");
    public final static OtsReaderError INVALID_PARAM = new OtsReaderError("OtsReaderInvalidParameter");
