...
public class RangeSplitByPointUnittest {
     ...
     */
    @Test
    public void testBasePartitionKeyEqual() {
        // integer类型的切分
        {
            ...
            rangeBegin.add(PrimaryKeyValue.fromString("嘻嘻"));
            
            List<PrimaryKeyValue> rangeEnd = new ArrayList<PrimaryKeyValue>();
            rangeEnd.add(PrimaryKeyValue.fromLong(Long.MIN_VALUE));
            rangeEnd.add(PrimaryKeyValue.fromString("哈哈"));
            
            conf.setRangeBegin(rangeBegin);
            conf.setRangeEnd(rangeEnd);
            
            OTSRange range = new OTSRange();
            range.setBegin(ParamChecker.checkInputPrimaryKeyAndGet(meta, conf.getRangeBegin()));
            range.setEnd(ParamChecker.checkInputPrimaryKeyAndGet(meta, conf.getRangeEnd()));
        ...
        // string类型的切分
        {
            ...
            List<PrimaryKeyValue> rangeEnd = new ArrayList<PrimaryKeyValue>();
            rangeEnd.add(PrimaryKeyValue.fromString("嘻嘻"));
            rangeEnd.add(PrimaryKeyValue.fromLong(Long.MIN_VALUE));
    ...
    public void testBase1PK() {
        ...
        
        {
            ...
            assertEquals(true, Common.compareRangeBeginAndEnd(meta, r0, ranges.get(0).getBegin()) == 0);
            assertEquals(true, Common.compareRangeBeginAndEnd(meta, r1, ranges.get(0).getEnd()) == 0);
            assertEquals(true, Common.compareRangeBeginAndEnd(meta, r1, ranges.get(1).getBegin()) == 0);
            assertEquals(true, Common.compareRangeBeginAndEnd(meta, r2, ranges.get(1).getEnd()) == 0);
            assertEquals(true, Common.compareRangeBeginAndEnd(meta, r2, ranges.get(2).getBegin()) == 0);
            assertEquals(true, Common.compareRangeBeginAndEnd(meta, r3, ranges.get(2).getEnd()) == 0);
            assertEquals(true, Common.compareRangeBeginAndEnd(meta, r3, ranges.get(3).getBegin()) == 0);
            assertEquals(true, Common.compareRangeBeginAndEnd(meta, r4, ranges.get(3).getEnd()) == 0);
        }
    }
    ...
    public void testBoundaryNumberTest() {
        ...
        
        {
            ...
            assertEquals(true, Common.compareRangeBeginAndEnd(meta, r3, ranges.get(3).getBegin()) == 0);
            assertEquals(true, Common.compareRangeBeginAndEnd(meta, r4, ranges.get(3).getEnd()) == 0);
            assertEquals(true, Common.compareRangeBeginAndEnd(meta, r4, ranges.get(4).getBegin()) == 0);
            assertEquals(true, Common.compareRangeBeginAndEnd(meta, r5, ranges.get(4).getEnd()) == 0);
            assertEquals(true, Common.compareRangeBeginAndEnd(meta, r5, ranges.get(5).getBegin()) == 0);
            assertEquals(true, Common.compareRangeBeginAndEnd(meta, r6, ranges.get(5).getEnd()) == 0);
            assertEquals(true, Common.compareRangeBeginAndEnd(meta, r6, ranges.get(6).getBegin()) == 0);
            assertEquals(true, Common.compareRangeBeginAndEnd(meta, r7, ranges.get(6).getEnd()) == 0);
            assertEquals(true, Common.compareRangeBeginAndEnd(meta, r7, ranges.get(7).getBegin()) == 0);
            assertEquals(true, Common.compareRangeBeginAndEnd(meta, r8, ranges.get(7).getEnd()) == 0);
            assertEquals(true, Common.compareRangeBeginAndEnd(meta, r8, ranges.get(8).getBegin()) == 0);
            assertEquals(true, Common.compareRangeBeginAndEnd(meta, r9, ranges.get(8).getEnd()) == 0);
            assertEquals(true, Common.compareRangeBeginAndEnd(meta, r9, ranges.get(9).getBegin()) == 0);
            assertEquals(true, Common.compareRangeBeginAndEnd(meta, r10, ranges.get(9).getEnd()) == 0);
        }
    }
}
