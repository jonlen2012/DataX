    ...
    public static List<RecordColumn> getRecordColumns(int colNum, StreamRecord.RecordType recordType) {
        ...
        for (int i = 0; i < colNum; i++) {
            ...
            for (int j = 0; j < getRandomInt(maxVersions); j++) {
                com.aliyun.openservices.ots.internal.model.Column column = new com.aliyun.openservices.ots.internal.model.Column(colName, getColumnValue(), getRandomInt(1000000000));
