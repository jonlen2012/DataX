...
public class ParameterTest {
    ...
    public void testParameterIntegrity() {
        ...
        try {
            ...
            assertEquals("Must set date or time range.", ex.getCause().getMessage());
        }
    }
    ...
    public void testDataTableCheck() {
        try {
            ...
            assertEquals("The data table is not existing.", ex.getCause().getMessage());
        }
        ...
        try {
            ...
            assertEquals("The data table stream is not enabled.", ex.getCause().getMessage());
        }
    }
        ...
        for (long startTime : startTimes) {
            ...
            try {
                ...
                if (startTime < minTime) {
                    assertTrue(ex.getCause().getMessage().startsWith("Start timestamp(" + startTime + ") is too small"));
                } else {
                    assertTrue(ex.getCause().getMessage().startsWith("End timestamp(" + endTime + ") is too large"));
                }
            }
        }
