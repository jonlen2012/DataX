...
/home/ads/tools/apache-maven-3.0.3/bin/mvn clean 
...
cp -rf $OLDPWD/../target/datax/* .%{_prefix}/

%post
chmod -R 0755 %{_prefix}/bin
chmod -R 0755 %{_prefix}/tools
chmod -R 0777 %{_prefix}/conf
chmod -R 0777 %{_prefix}/jobs
chmod -R 0777 %{_prefix}/logs
chmod -R 0777 %{_prefix}/temp
rm -rf %{_prefix}/temp/*
...
%config(noreplace) %{_prefix}/conf/core.alisa.xml
%config(noreplace) %{_prefix}/conf/core.alisa.p2p.xml
%{_prefix}
