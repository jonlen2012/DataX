 ...
 * 主要是测试各种类型转换为Int的行为
 */
public class ConversionIntAttrFunctiontest extends BaseTest{
    ...
    public void testStringToInt() throws Exception {
        ...
        // 传入值是String
        {
            ...
            Row row = OTSRowBuilder.newInstance()
                    ...
                    .addAttrColumn(getColumnName(0),  ColumnValue.fromLong(-100), 1)
                    .toRow();
            expect.add(row);
        }
        {
            ...
            Row row = OTSRowBuilder.newInstance()
                    ...
                    .addAttrColumn(getColumnName(0),  ColumnValue.fromLong(1000), 1)
                    .toRow();
            expect.add(row);
        }
        {
    ...
    public void testIntToInt() throws Exception {
        ...
        // 传入值是Int
        {
            ...
            Row row = OTSRowBuilder.newInstance()
                    ...
                    .addAttrColumn(getColumnName(0),  ColumnValue.fromLong(Long.MIN_VALUE), 1)
                    .toRow();
            expect.add(row);
        }
        {
            ...
            Row row = OTSRowBuilder.newInstance()
                    ...
                    .addAttrColumn(getColumnName(0),  ColumnValue.fromLong(Long.MAX_VALUE - 1), 1)
                    .toRow();
            expect.add(row);
        }
        {
    ...
    public void testDoubleToInt() throws Exception {
        ...
        // 传入值是Double
        {
            ...
            Row row = OTSRowBuilder.newInstance()
                    ...
                    .addAttrColumn(getColumnName(0),  ColumnValue.fromLong(-9012), 1)
                    .toRow();
            expect.add(row);
        }
        {
        ...
        }
        {
            ...
            Row row = OTSRowBuilder.newInstance()
                    ...
                    .addAttrColumn(getColumnName(0),  ColumnValue.fromLong(1211), 1)
                    .toRow();
            expect.add(row);
        }
        // check
    ...
    public void testBoolToInt() throws Exception {
        ...
        
        {
            ...
            Row row = OTSRowBuilder.newInstance()
                    ...
                    .addAttrColumn(getColumnName(0),  ColumnValue.fromLong(1), 1)
                    .toRow();
            expect.add(row);
        }
        {
