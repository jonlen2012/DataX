...
public class DataChecker {
    ...
    private static boolean cmpRowWithNoTS(Row src, Row expect) {
        com.aliyun.openservices.ots.internal.model.Column[] srcColumn = src.getColumns();
        com.aliyun.openservices.ots.internal.model.Column[] expectColumn = expect.getColumns();
        // 判断个数是否相等
        ...
        for (int i = 0; i < srcColumn.length; i++) {
            com.aliyun.openservices.ots.internal.model.Column sc = srcColumn[i];
            com.aliyun.openservices.ots.internal.model.Column ec = expectColumn[i];
