...
public class ParseRecordUnittest {
    ...
    public void test_normal_valid_put() throws OTSCriticalException {
        // user configuration
        LinkedHashMap<PrimaryKeySchema, Integer> pkColumns = new LinkedHashMap<PrimaryKeySchema, Integer>();
        pkColumns.put(new PrimaryKeySchema("pk_0", PrimaryKeyType.STRING), 0);
        pkColumns.put(new PrimaryKeySchema("pk_1", PrimaryKeyType.INTEGER), 1);
