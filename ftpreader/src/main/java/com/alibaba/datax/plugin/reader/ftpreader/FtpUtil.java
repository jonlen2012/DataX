...
public class FtpUtil {
	...
	/*
	 * private static class FtpUtilHolder { private static final FtpUtil
	 * INSTANCE = new FtpUtil(); } private FtpUtil(){} public static final
	 * FtpUtil getInstance() { return FtpUtilHolder.INSTANCE; }
	 */
