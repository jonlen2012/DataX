...
public class DistributeScheduleTest {
    ...
    public void testStartAllTaskGroup() {
        ...
        PowerMockito.when(DataxServiceUtil.startTaskGroup(anyLong(), any(TaskGroup.class))).
                thenReturn(result);
        DistributeScheduler scheduler = new DistributeScheduler();
    ...
    public void testDealFailedStat() throws NoSuchFieldException, IllegalAccessException {
        ...
        DistributeJobContainerCollector containerCollector = new DistributeJobContainerCollector(configuration);
    ...
    public void testSchedule() {
        ...
        DistributeJobContainerCollector jobContainerCollector =
                PowerMockito.mock(DistributeJobContainerCollector.class);
