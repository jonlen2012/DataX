...
public class Configuration {
	...
	public static Configuration from(final Map<String, Object> object) {
		return Configuration.from(JSON.toJSONString(object));
	}
	 ...
	 * 
	 * @return Boolean对象，如果path不存在或者值非 true,false ，返回null
	 */
	...
	public List<Configuration> getListConfiguration(final String path) {
		...
		for (final Object object : lists) {
			result.add(Configuration.from(JSON.toJSONString(object)));
		}
		return result;
	}
	...
	public Map<String, Configuration> getMapConfiguration(final String path) {
		...
		for (final String key : map.keySet()) {
			result.put(key, Configuration.from(JSON.toJSONString(map.get(key))));
		}
	...
	public String beautify() {
		return JSON.toJSONString(this.getInternal(), true);
	}
	...
	public Configuration clone() {
		return Configuration.from(JSON.toJSONString(this.getInternal()));
	}
