package com.alibaba.datax.plugin.writer.hbasebulkwriter2_11x.column;

import com.alibaba.datax.common.exception.DataXException;
import com.alibaba.datax.common.util.RetryUtil;
import com.alibaba.datax.plugin.writer.hbasebulkwriter2_11x.BulkWriterError;
import com.alibaba.datax.plugin.writer.hbasebulkwriter2_11x.util.PhoenixEncoder;
...
public class HBaseColumn {
     ...
     */
    public static void checkColumnList(final Table htable, List<? extends HBaseColumn> columnList, int retryTimes) {
        final String tableName = Bytes.toString(htable.getName().getName());
