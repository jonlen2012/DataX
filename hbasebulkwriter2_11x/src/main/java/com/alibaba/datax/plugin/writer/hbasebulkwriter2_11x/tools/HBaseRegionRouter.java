...
import com.alibaba.datax.plugin.writer.hbasebulkwriter2_11x.HBaseHelper;
...
public class HBaseRegionRouter extends UDF {
    ...
    public static JSONArray getRegionsJson(String table, String confPath, String configStr, String clusterId) {
        ...
        try {
            regionLocator = HBaseHelper.getRegionLocator(conf, table);

            Pair<byte[][], byte[][]> startEndKeysPair = regionLocator
                    .getStartEndKeys();
            ...
            if (regionLocator != null) {
                try {
                    ...
                    LOG.warn("fail to close regionLocator ", e);
                }
            }
        }
        return regionsJson;
