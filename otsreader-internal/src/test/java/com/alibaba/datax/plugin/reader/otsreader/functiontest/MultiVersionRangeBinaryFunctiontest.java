 ...
 */
public class MultiVersionRangeBinaryFunctiontest {
    ...
    public void testCustomRangeBeginAndEnd() throws Exception {
        Map<String, String> lines = getLines();
        lines.put("range", "'range':{"
                + "'begin':[{'type':'binary', 'value':'"+ TestHelper.getBase64("000100") +"'}], "
                + "'end':  [{'type':'binary', 'value':'"+ TestHelper.getBase64("000120") +"'}]}");
        Configuration c = Configuration.from(ConfigurationHelper.linesToJson(lines));
        TestHelper.test(c);
    }
    ...
    public void testCustomRangeSplit() throws Exception {
        Map<String, String> lines = getLines();
        lines.put("range", "'range':{"
                + "'split':[{'type':'binary', 'value':'"+ TestHelper.getBase64("000050") +"'},{'type':'binary', 'value':'"+ TestHelper.getBase64("000080") +"'},{'type':'binary', 'value':'"+ TestHelper.getBase64("000100") +"'},{'type':'binary', 'value':'"+ TestHelper.getBase64("000130") +"'}]}");
        Configuration c = Configuration.from(ConfigurationHelper.linesToJson(lines));
        TestHelper.test(c);
    }
    ...
    public void testCustomRangeBeginAndEndAndSplit() throws Exception {
        Map<String, String> lines = getLines();
        lines.put("range", "'range':{"
                + "'begin':[{'type':'binary', 'value':'"+ TestHelper.getBase64("000040") +"'}], "
                + "'end':  [{'type':'binary', 'value':'"+ TestHelper.getBase64("000140") +"'}],"
                + "'split':[{'type':'binary', 'value':'"+ TestHelper.getBase64("000050") +"'},{'type':'binary', 'value':'"+ TestHelper.getBase64("000080") +"'},{'type':'binary', 'value':'"+ TestHelper.getBase64("000100") +"'},{'type':'binary', 'value':'"+ TestHelper.getBase64("000130") +"'}]}");
        Configuration c = Configuration.from(ConfigurationHelper.linesToJson(lines));
        TestHelper.test(c);
    }
    ...
    public void testCustomReverseRangeBeginAndEndAndSplit() throws Exception {
        Map<String, String> lines = getLines();
        lines.put("range", "'range':{"
                + "'begin':[{'type':'binary', 'value':'"+ TestHelper.getBase64("000140") +"'}], "
                + "'end':  [{'type':'binary', 'value':'"+ TestHelper.getBase64("000001") +"'}],"
                + "'split':[{'type':'binary', 'value':'"+ TestHelper.getBase64("000130") +"'},{'type':'binary', 'value':'"+ TestHelper.getBase64("000100") +"'},{'type':'binary', 'value':'"+ TestHelper.getBase64("000080") +"'},{'type':'binary', 'value':'"+ TestHelper.getBase64("000030") +"'}]}");
        Configuration c = Configuration.from(ConfigurationHelper.linesToJson(lines));
        TestHelper.test(c);
    }
}
