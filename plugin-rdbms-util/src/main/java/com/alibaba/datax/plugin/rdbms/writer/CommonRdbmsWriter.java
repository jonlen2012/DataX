			...
			try {
				...
				while ((record = recordReceiver.getFromReader()) != null) {
					if (record.getColumnNumber() != this.columnNumber) {
						...
						throw DataXException.asDataXException(DBUtilErrorCode.CONF_ERROR, String.format(
				...
				throw DataXException
						.asDataXException(
								...
								String.format(
										...
										this.resultSetMetaData.getLeft().get(columnIndex), this.resultSetMetaData
												.getMiddle().get(columnIndex),
