...
public enum DBUtilErrorCode implements ErrorCode {
    CONN_DB_ERROR("DBUtilErrorCode-10", "Connect to DataBase failed: Please check your IP/Port/Database/User/Pass is available !"),
    JDBC_CONTAINS_BLANK_ERROR("DBUtilErrorCode-11", "Configuration jdbcUrl Cannot be null :  Please check your configuration of jdbcUrl !"),
    UNSUPPORTED_TYPE("DBUtilErrorCode-12", "Unsupported database type: I cannot help you, sorry. Please ask your administrator for HELP !"),
    COLUMN_SPLIT_ERROR("DBUtilErrorCode-13", "Column split failed ."),
	SET_SESSION_ERROR("DBUtilErrorCode-14", "Set session configuration failed ."),
    ...
    SQL_EXECUTE_FAIL("DBUtilErrorCode-06", "Failed to execute database sql: Please check your Column/Table/Where/querySql !"),
    READ_RECORD_FAIL("DBUtilErrorCode-07", "Failed to read database record: Please check your Column/Table/Where/querySql !"),
