...
public final class DBUtil {
    ...
    public static List<String> getTableColumns(DataBaseType dataBaseType, String jdbcUrl, String user,
        ...
        try {
            ...
            throw DataXException.asDataXException(
                    DBUtilErrorCode.GET_COLUMN_INFO_FAILED, "获取表的所有字段名称时失败.", e);
        } finally {
    ...
    public static ResultSetMetaData getColumnMetaData(DataBaseType dataBaseType, String jdbcUrl, String user,
    ...
    public static ResultSetMetaData getColumnMetaData(Connection conn, String tableName, String column) {
        ...
        try {
            ...
            throw DataXException.asDataXException(
                    DBUtilErrorCode.GET_COLUMN_INFO_FAILED, "获取表的字段的元信息时失败.", e);
        } finally {
