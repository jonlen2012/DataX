 ...
 * 主要是测试各种类型转换为Int的行为
 */
public class ConversionIntPKFunctiontest {
    ...
    public void testStringToInt() throws Exception {
        ...
        // 传入值是String
        {
            ...
            row.put("pk_1", ColumnValue.fromLong(-100));
            expect.add(row);
        }
        {
            Record r = new DefaultRecord();
            ...
            row.put("pk_1", ColumnValue.fromLong(1000));
            expect.add(row);
        }
        {
            Record r = new DefaultRecord();
            ...
            row.put("pk_1", ColumnValue.fromLong(0));
            expect.add(row);
        }
    ...
    public void testIntToInt() throws Exception {
        ...
        // 传入值是Int
        {
            ...
            row.put("pk_1", ColumnValue.fromLong(Long.MIN_VALUE));
            expect.add(row);
        }
        {
            Record r = new DefaultRecord();
            ...
            row.put("pk_1", ColumnValue.fromLong(Long.MAX_VALUE - 1));
            expect.add(row);
        }
        {
            Record r = new DefaultRecord();
    ...
    public void testDoubleToInt() throws Exception {
        ...
        // 传入值是Double
        {
            ...
            row.put("pk_1", ColumnValue.fromLong(-9012));
            expect.add(row);
        }
        {
            Record r = new DefaultRecord();
        ...
        }
        {
            ...
            row.put("pk_1", ColumnValue.fromLong(1211));
            expect.add(row);
        }
    ...
    public void testBoolToInt() throws Exception {
        ...
        
        {
            ...
            row.put("pk_1", ColumnValue.fromLong(1));
            expect.add(row);
        }
        {
            Record r = new DefaultRecord();
